...
- [https://ggplot2.tidyverse.org](https://ggplot2.tidyverse.org)
    - Cheatsheet: [https://github.com/rstudio/cheatsheets/blob/master/data-visualization.pdf](https://github.com/rstudio/cheatsheets/blob/master/data-visualization.pdf)
- R graph gallery: [https://r-graph-gallery.com](https://r-graph-gallery.com)
- R Graphics Cookbook 2nd ed: [https://r-graphics.org](https://r-graphics.org)
